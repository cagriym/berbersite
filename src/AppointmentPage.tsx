        ...
        <div className="w-full p-4 sm:p-0 sm:w-auto">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select 
                id="time" 
                className="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-amber-500 focus:border-amber-500 text-sm transition hover:border-amber-400" 
                value={selectedTime} 
              ...
              >
                ...
                {availableTimes.map(time => (
                  <option 
                    ...
                    className={!isTimeAvailable(time) ? 'text-gray-400' : ''}
                  >
            ...
            {message && (
              <div className={`col-span-1 md:col-span-2 p-4 rounded-lg text-center font-medium transition-all duration-500 ${
                messageType === 'success' 
                  ? 'bg-green-50 border-2 border-green-200 text-green-800 shadow-lg' 
                  : 'bg-red-50 border-2 border-red-200 text-red-800 shadow-lg'
              }`}>
                <div className="flex items-center justify-center mb-2">
                  {messageType === 'success' ? (
                    <i className="fas fa-check-circle text-2xl text-green-600 mr-2"></i>
                  ) : (
                    <i className="fas fa-exclamation-circle text-2xl text-red-600 mr-2"></i>
                  )}
