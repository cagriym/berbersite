    ...
    return (
        <div className="w-64 h-full bg-white border-r shadow-sm flex flex-col">
            ...
            <nav className="flex-1 px-2 py-4 space-y-2">
                ...
                <NavLink to="/admin/contact-messages" className={({ isActive }) => `flex items-center px-4 py-2 mt-2 text-gray-600 rounded-md hover:bg-amber-100 hover:text-amber-700 ${isActive ? 'bg-amber-200 text-amber-800' : ''}`}>
                    <i className="fas fa-envelope mr-3"></i> İletişim Mesajları
                </NavLink>
            </nav>
